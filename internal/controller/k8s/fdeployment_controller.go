...
func (r *FdeploymentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	flog.Info("limitCpu.Value()", limitCpu.MilliValue())
	...
	flog.Info("foundDeployment.Spec.Template.Spec.Containers[0].Resources.Limits.Cpu().Value()", foundDeployment.Spec.Template.Spec.Containers[0].Resources.Limits.Cpu().MilliValue())
